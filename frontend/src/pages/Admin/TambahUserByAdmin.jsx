      ...
      <div className="flex flex-col flex-1 min-h-screen">
        ...
        <div className="p-8 flex flex-col gap-6 w-full max-w-[1200px] mx-auto flex-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-500 text-xs font-bold uppercase tracking-wide">ADD NEW USER</span>
          </div>
          <div className="flex flex-col gap-1">
            <h1 className="text-stone-800 text-4xl font-black leading-tight">Add New User</h1>
            <p className="text-zinc-600 text-base font-medium">Create a new profile for students, instructors, or administrators.</p>
          </div>
