		...
		<div className="flex flex-col bg-white">
			<div className="self-stretch bg-white">
				<div className="flex justify-between items-center self-stretch bg-[#FFFFFFCC] pt-[18px] pb-[19px] px-6">
					...
					<button className="flex flex-col shrink-0 items-start bg-white text-left py-2.5 px-8 rounded-[9999px] border border-[#E040A033] hover:bg-purple-50 transition"
						style={{
							boxShadow: "0px 4px 6px #E040A022"
						}}
						onClick={() => navigate("/login")}>
						<span className="text-[#E040A0] text-base font-bold" >
							{"Get Started"}
						</span>
					</button>
				</div>
				<div className="flex flex-col self-stretch mb-[168px]">
					<div className="self-stretch bg-[#00000000] pt-16 mb-[1px]">
						<div className="flex items-center self-stretch mb-[49px] mx-6 gap-16">
							<div className="flex flex-1 flex-col items-start pr-3">
								...
								<div className="flex flex-col items-start self-stretch pt-8">
									<span className="text-[#2E1A28] text-7xl font-bold w-[521px]" >
										{"Study Smarter,\nGet Better\nGrades."}
									</span>
								</div>
								<div className="flex flex-col items-start self-stretch pt-8">
									<span className="text-[#604868] text-lg w-[473px]" >
							...
							<div className="flex flex-1 flex-col items-start pl-3">
								<button className="flex flex-col items-start bg-[#FFFFFF00] text-left p-3 rounded-[48px] border-[12px] border-solid border-[#FFFFFF80]"
									style={{
										boxShadow: "0px 25px 50px #00000040"
									}}
									onClick={() => alert("Pressed!")}>
									<div className="flex flex-col items-start bg-cover bg-center pt-[512px] pl-64 pr-[25px] rounded-[48px]"
										style={{
					...
					<div className="flex items-center self-stretch mb-[156px] mx-6 gap-16">
						<div className="flex flex-1 flex-col items-start py-[1px] gap-[31px]">
							<div className="flex flex-col items-start self-stretch">
								<span className="text-[#2E1A28] text-5xl font-bold w-[512px]" >
						...
						<img
							...
							className="flex-1 h-[524px] object-fill"
						/>
					</div>
					<div className="flex items-center self-stretch bg-[#FBF2FB] py-24 px-6 mb-[76px] gap-16">
						<div className="flex-1 bg-[#FFFFFF00] p-[41px] rounded-[48px]"
							style={{
						...
						<div className="flex flex-1 flex-col items-start pt-[1px]">
							...
							<div className="flex flex-col items-start self-stretch mb-[30px]">
								<span className="text-[#604868] text-lg w-[510px]" >
					...
					<div className="flex flex-col items-center self-stretch bg-[#FDF2F5] py-[93px] px-48 mb-[135px] gap-8">
						<img
						...
						/>
						<div className="flex flex-col items-start self-stretch pt-[7px]">
							<span className="text-[#2E1A28] text-5xl font-bold text-center w-[776px]" >
					...
					<button className="flex flex-col items-center self-stretch text-left py-[95px] mx-6 rounded-[64px] border-0"
						style={{
						...
						<div className="flex flex-col items-center gap-10">
							...
							<span className="text-white text-xl text-center w-[552px]" >
								{"Join thousands of high-achievers who have transformed their grades\nand their futures with My Better Grade."}
							</span>
							<div className="flex flex-col items-start bg-[#FFFFFF00] py-5 px-12 rounded-[9999px]"
								style={{
									boxShadow: "0px 8px 10px #0000001A"
								}}>
				...
				<div className="flex flex-col self-stretch bg-[#F2E8F2] pt-20 pb-[177px] px-6 gap-16">
					<div className="flex items-start self-stretch gap-16">
