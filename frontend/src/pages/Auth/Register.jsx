		...
		<div className="flex flex-col bg-white">
			<div className="flex flex-col items-start self-stretch bg-white">
				...
				<div className="flex flex-col items-center self-stretch mb-8">
					<div className="flex flex-col items-center bg-[#FFFFFFCC] p-8 md:p-[49px] gap-10 rounded-[48px] border border-solid border-[#E040A01A] w-full max-w-[700px] mx-auto"
						style={{
						...
						<div className="flex flex-col items-center gap-8 w-full">
							<div className="flex flex-col items-start pt-0.5 gap-[18px] w-full max-w-[560px]">
								<span className="text-[#604868] text-sm font-bold ml-1" >
									{"I AM A..."}
								</span>
								<div className="flex flex-col sm:flex-row items-center gap-4 w-full">
									<div
										className={`flex flex-1 flex-col shrink-0 items-center py-[26px] px-6 gap-3 rounded-[32px] border-2 border-solid cursor-pointer hover:border-[#E040A0] transition w-full ${role === 'student' ? 'border-[#E040A0] bg-[#FEF7FF]' : 'border-[#DCC8E0] bg-white'}`}
									...
									>
										...
										<div className="flex flex-col items-center w-full">
											...
											<span className="text-[#604868] text-xs text-center" >
												{"Track grades & ace exams"}
											</span>
										</div>
									</div>
									<div
										className={`flex flex-1 flex-col shrink-0 items-center py-[26px] px-6 gap-3 rounded-[32px] border-2 border-solid cursor-pointer hover:border-[#E040A0] transition w-full ${role === 'teacher' ? 'border-[#E040A0] bg-[#FEF7FF]' : 'border-[#DCC8E0] bg-white'}`}
							...
							<div className="flex flex-col sm:flex-row items-center gap-6 w-full max-w-[560px]">
								<div className="flex flex-col items-start gap-2 w-full flex-1">
									...
									<input
										...
										className="text-[#2E1A28] bg-[#FFFFFF80] text-base py-[17px] px-[22px] rounded-[9999px] border-2 border-solid border-[#DCC8E0] w-full outline-none"
									/>
								</div>
								<div className="flex flex-col items-start gap-2 w-full flex-1">
									<span className="text-[#604868] text-sm font-bold pl-1" >
							...
							<div className="flex items-start px-2 gap-3 w-full max-w-[560px]">
							...
							<button className="flex items-center justify-center bg-[#F080C0] py-[18px] w-full max-w-[560px] gap-[11px] rounded-[9999px] border-0 text-[#2E1A28] text-lg font-bold cursor-pointer hover:bg-[#E040A0] transition"
								style={{
				...
				<div className="flex flex-col items-center self-stretch text-center px-4 w-full">
					<span className="text-[#604868] text-sm" >
						{"Empowering over 50,000 students globally."}
					</span>
				</div>
				<div className="flex flex-wrap items-center justify-center mt-6 mb-12 gap-6 w-full text-center">
					<span className="text-[#907898] text-xs font-bold cursor-pointer hover:text-[#E040A0]" onClick={() => navigate("/")}>
						{"HELP CENTER"}
					</span>
					<span className="text-[#907898] text-xs font-bold cursor-pointer hover:text-[#E040A0]" onClick={() => navigate("/")}>
						{"SYSTEM STATUS"}
