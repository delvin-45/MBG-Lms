		...
		<div className="relative min-h-screen bg-[#FEF7FF]">
			...
			<div className="flex flex-col bg-white min-h-screen">
				<div className="self-stretch bg-white min-h-screen">
					<div className="flex flex-col md:flex-row items-stretch self-stretch min-h-screen">
						<div className="hidden lg:flex flex-1 flex-col items-start pt-36"
							style={{
								background: "linear-gradient(180deg, #E040A099, #E040A000)"
							}}>
							<span className="text-white text-5xl md:text-6xl font-bold w-full max-w-[356px] mb-24 md:mb-[489px] ml-16 mt-6" >
								{"Focus on\nwhat matters."}
							</span>
							<div className="w-full max-w-[357px] h-[136px] mb-16 ml-16">
							</div>
						</div>
						<div className="flex flex-1 flex-col items-center justify-center bg-[#FEF7FF] py-12 md:py-[81px] gap-8 md:gap-[50px] px-6">
							<img
							...
							<div className="flex flex-col items-center gap-10 w-full">
								<div className="flex flex-col items-start w-full max-w-[420px]">
									...
									<span className="text-[#2E1A28] text-2xl md:text-3xl font-bold" >
										{"Welcome back!"}
									</span>
									<div className="flex flex-col items-start pt-2">
										<span className="text-[#604868] text-sm md:text-base" >
								...
								<div className="flex flex-col items-center pt-2 gap-6 w-full max-w-[420px]">
									<div className="flex flex-col items-start gap-2 w-full">
										...
										<div className="flex items-center bg-[#FBF2FB] py-[17px] px-5 gap-[17px] rounded-[9999px] border border-solid border-[#DCC8E0] w-full">
											<img
									...
									<div className="flex flex-col items-start gap-2 w-full">
										...
										<div className="flex items-center bg-[#FBF2FB] py-[17px] px-5 rounded-[9999px] border border-solid border-[#DCC8E0] w-full">
											<img
									...
									<button className="flex items-center bg-[#E040A0] justify-center py-4 w-full gap-2.5 rounded-[9999px] border-0 text-white font-bold text-lg cursor-pointer hover:bg-[#c03080] transition"
										style={{
								...
								<div className="flex flex-col sm:flex-row items-center gap-4 w-full">
									<button className="flex flex-1 justify-center items-center bg-transparent py-[13px] px-6 gap-3 rounded-[9999px] border border-solid border-[#DCC8E0] w-full"
