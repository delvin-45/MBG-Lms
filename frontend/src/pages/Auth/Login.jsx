				...
				<div className="self-stretch bg-white">
					<div className="flex items-center self-stretch">
						<div className="flex flex-1 flex-col items-start pt-36" 
							...
							<button className="flex flex-col items-start bg-[#FFFFFF33] text-left py-1 px-4 mb-[13px] ml-[82px] mr-[212px] rounded-[9999px] border-0"
								onClick={()=>alert("Premium education platform.")}>
								<span className="text-black text-sm font-bold" >
									{"PREMIUM LEARNING"}
								</span>
							</button>
							<span className="text-white text-6xl font-bold w-[356px] mb-[489px] ml-16" >
								{"Focus on\nwhat matters."}
							</span>
